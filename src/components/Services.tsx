...
const services = [
  ...
  },
  {
    ...
    body: "Lee facturas, pedidos y albaranes que llegan por correo y los incorpora a tu sistema.",
    time: "2–3 semanas",
  },
  {
    code: "IA / 03",
    ...
    body: "Responde a tu equipo con tus manuales, tarifas y procedimientos; no con información genérica.",
    time: "3 semanas",
  },
  {
    code: "DATA / 01",
    ...
    body: "Tus sistemas conectados, entre cinco y ocho indicadores y un resumen semanal automático.",
    time: "3–4 semanas",
  },
  {
    code: "DATA / 02",
    category: "data",
    price: "desde 4.900 €",
    title: "Previsión de demanda y stock",
    body: "Un modelo sobre tu histórico que propone el pedido o la producción de la semana.",
    time: "4 semanas",
  },
  {
    code: "DEV / 01",
    ...
    price: "desde 5.900 €",
    title: "CRM a medida",
    body: "Diseñado sobre tu proceso de venta, sin licencias por usuario que crecen cada año.",
    time: "4–6 semanas",
  },
  {
    code: "DEV / 02",
    ...
    body: "Conectamos ERP, tienda, CRM y facturación para que la información deje de copiarse a mano.",
    time: "2–4 semanas",
  },
  {
    code: "ADOPT / 01",
    category: "adoption",
    price: "desde 1.900 €",
    title: "Workspace y Gemini en marcha",
    body: "Licencias, seguridad, permisos y dos sesiones de formación por equipo.",
    time: "2 semanas",
  },
  {
    code: "ADOPT / 02",
    category: "adoption",
    price: "desde 1.900 €",
    title: "Microsoft 365 y Copilot",
    body: "Implantación, seguridad y formación para equipos que ya trabajan en el entorno Microsoft.",
    time: "2 semanas",
  },
]
